...
public class AiController {
    ...
    public ResponseEntity<Object> analyzeRisk(
            @RequestPart("space_type") @NotBlank(message = "space_type은 필수입니다.") String spaceType,
            @RequestPart("pyeong") @NotNull(message = "pyeong은 필수입니다.") @Min(value = 1, message = "pyeong은 1 이상이어야 합니다.") Integer pyeong,
            @RequestPart("room_count") @NotNull(message = "room_count는 필수입니다.") @Min(value = 0, message = "room_count는 0 이상이어야 합니다.") Integer roomCount,
            @RequestPart("floor") @NotNull(message = "floor는 필수입니다.") Integer floor,
            @RequestPart("elevator") @NotNull(message = "elevator는 필수입니다.") Boolean elevator,
            @RequestPart("region") @NotBlank(message = "region은 필수입니다.") String region,
            @RequestPart("building_age") @NotBlank(message = "building_age는 필수입니다.") String buildingAge,
            @RequestPart("company_name") @NotBlank(message = "company_name은 필수입니다.") String companyName,
